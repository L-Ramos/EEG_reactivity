...
#for p in range(0,1):
    ...
    path_features=r"L:\basic\divd\knf\Onderzoek_projecten\EEG_IC\DeepEEG\final_DeepEEGdata\\"+secs+"Sec\\frequencyFeatures_fft\\*"+stimulus[p]+"*"+pre_post+"*Stim.txt"
    ...
    pat_id=pd.DataFrame(pat_id,columns=['IDS'])
    label_id=pd.DataFrame(list_label,columns=['Outcome'])
